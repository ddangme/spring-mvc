# 목차
- [x] [검증 요구사항](#검증-요구사항)
- [x] [검증 직접 처리 - 소개](#검증-직접-처리---소개)
- [x] [검증 직접 처리 - 개발](#검증-직접-처리---개발)
- [x] [BindingResult1](#bindingresult1)
- [x] [BindingResult2](#bindingresult2)
- [x] [FieldError, ObjectError](#fielderror-objecterror)
- [x] [오류 코드와 메시지 처리 1](#오류-코드와-메시지-처리-1)
- [x] [오류 코드와 메시지 처리 2](#오류-코드와-메시지-처리-2)
- [x] [오류 코드와 메시지 처리 3](#오류-코드와-메시지-처리-3)
- [x] [오류 코드와 메시지 처리 4](#오류-코드와-메시지-처리-4)
- [x] [오류 코드와 메시지 처리 5](#오류-코드와-메시지-처리-5)
- [x] [오류 코드와 메시지 처리 6](#오류-코드와-메시지-처리-6)
- [x] [Validator 분리](#validator-분리)
- [x] [Validator 분리 2](#validator-분리-2)
...
```java
  ...
  public String addItem(@ModelAttribute Item item, RedirectAttributes redirectAttributes, Model model) {
      ...
      return "redirect:/items/v1/items/{itemId}";
  }
```
        ...
        <div class="row">
            ...
            <div class="col">
                <button class="w-100 btn btn-secondary btn-lg"
                        ...
                        th:onclick="|location.href='@{/items/v1/items}'|"
    ...
    <form action="item.html" th:action th:object="${item}" method="post">
        ...
        <div class="row">
            ...
            <div class="col">
                <button class="w-100 btn btn-secondary btn-lg"
                        onclick="location.href='items.html'"
                        th:onclick="|location.href='@{/items/items}'|"
                        type="button" th:text="#{button.cancel}">취소</button>
            </div>
        </div>
...
크게 객체 오류와 필드 오류를 나누었다. 그리고 범용성에 따라 레빌을 나누었다.
